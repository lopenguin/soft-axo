/*
Changed by Lorenzo Shaikewitz on 8/8/2021 to accomodate two NXP sensors:
- Removed functions for altimeter
- Added constructor that takes in I2C address
*/
...
public:
	/* Constructor, for use with multiple boards/I2C addresses
	- Prop shield: use default arguments (FXOS8700_I2C_ADDR0, FXAS21002_I2C_ADDR0)
	- Adafruit shield: FXOS8700_I2C_ADDR3, FXAS21002_I2C_ADDR1
	NO ARGUMENT CHECKING IMPLEMENTED--USE WITH CARE.
	*/
	NXPMotionSense(uint8_t in_FXOS8700_addr = FXOS8700_I2C_ADDR0, uint8_t in_FXAS21002_addr = FXAS21002_I2C_ADDR0) :
		FXOS8700_ADDR{in_FXOS8700_addr}, FXAS21002_ADDR{in_FXAS21002_addr}
	{
		if (in_FXAS21002_addr == FXAS21002_I2C_ADDR0)
			NXP_MOTION_CAL_EEADDR = 60;
		else if (in_FXAS21002_addr == FXAS21002_I2C_ADDR1)
			NXP_MOTION_CAL_EEADDR = 160;
		else
			NXP_MOTION_CAL_EEADDR = 60;	// this is a problem, but whatever
	}
...
private:
	...
	uint8_t newdata;
	bool FXOS8700_updated{0};

	const uint8_t FXOS8700_ADDR;
	const uint8_t FXAS21002_ADDR;
	uint8_t NXP_MOTION_CAL_EEADDR;	// should be constant, but not to let me do a little more manipulation
};
